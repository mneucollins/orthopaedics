...
var testPatients = [{
	...
	apptType: "RPV",
	currentState: "DC",
	apptTime: new Date(new Date().getHours() - 3),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 100),
	EXTimestamp: new Date().setHours(new Date().getMinutes() - 90),
	DCTimestamp: new Date().setHours(new Date().getMinutes() - 20),
	apptDuration: 15
},{
	firstName: "Eddy",
	lastName: "Murphy",
	...
	apptType: "RPV",
	currentState: "EX",
	apptTime: new Date().setHours(new Date().getMinutes() - 60),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 65),
	EXTimestamp: new Date().setHours(new Date().getMinutes() - 20),
	apptDuration: 15
},{
	firstName: "Daniel",
	lastName: "Radcliffe",
	...
	currentState: "EX",
	apptTime: new Date().setHours(new Date().getMinutes() - 60),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 70),
	EXTimestamp: new Date().setHours(new Date().getMinutes() - 30),
	apptDuration: 15
},{
	firstName: "Chuck",
	lastName: "Norris",
	...
	apptType: "RPV",
	currentState: "WR",
	apptTime: new Date().setHours(new Date().getMinutes() - 5),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 3),
	apptDuration: 15
},{
	firstName: "Jackie",
	lastName: "Chan",
	...
	apptType: "RPV",
	currentState: "WR",
	apptTime: new Date().setHours(new Date().getMinutes() - 11),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 15),
	apptDuration: 15
},{
	firstName: "Jackie",
	lastName: "Holmes",
	...
	apptType: "RPV",
	currentState: "WR",
	apptTime: new Date().setHours(new Date().getMinutes() - 18),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 20),
	apptDuration: 15
},{
	firstName: "Jackie",
	lastName: "Jones",
	...
	apptType: "RPV",
	currentState: "WR",
	apptTime: new Date().setHours(new Date().getMinutes() - 35),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 39),
	apptDuration: 15
},{
	firstName: "Jackie",
	lastName: "Slinger",
	...
	apptType: "RPV",
	currentState: "WR",
	apptTime: new Date().setHours(new Date().getMinutes() - 57),
	WRTimestamp: new Date().setHours(new Date().getMinutes() - 60),
	apptDuration: 15
},{
	firstName: "Ryan",
	lastName: "Gosling",
	...
	apptType: "RPV",
	currentState: "NCI",
	apptTime: new Date().setHours(new Date().getMinutes() + 3),
	apptDuration: 35
}];
